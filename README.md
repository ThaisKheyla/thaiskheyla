...
![Kheyla's github activity graph](https://ssr-contributions-svg.vercel.app/_/ThaisKheyla?chart=3dbar&gap=0.6&scale=2&flatten=2&animation=wave&animation_duration=1&animation_delay=0.05&animation_amplitude=20&animation_frequency=0.5&animation_wave_center=10_0&format=svg&weeks=30&theme=purple)
...
## My Stack
<div align="center">
<img src="https://skillicons.dev/icons?i=arduino,aws,bash,bootstrap,cpp,css,devto,discord,figma,gcp,git,github,githubactions,gmail,html,htmx,instagram,java,js,linkedin,linux,kotlin,mint,mysql,nodejs,ps,php,powershell,pycharm,py,r,react,stackoverflow,sublime,tailwind,ubuntu,unity,visualstudio,vite,vscode,windows,wordpress,maven&theme=dark" />
